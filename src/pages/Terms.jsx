    ...
    <>
      ...
      <section className="min-h-screen bg-gradient-to-b from-blue-600 via-blue-500 to-indigo-900 text-white px-6 py-12 md:py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6">Terms & Conditions</h1>
          ...
          <div className="bg-blue-900 bg-opacity-40 backdrop-blur p-6 md:p-8 max-h-[70vh] overflow-y-auto rounded-2xl shadow-2xl border border-blue-400 border-opacity-30">
            ...
            <div className="mb-8">
              ...
              <p className="text-blue-100 text-sm md:text-base">By accessing or using the Zingerr app, you agree to be bound by these Terms. If you do not agree, please do not use the app.</p>
            </div>
            {/* Section 2 */}
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">2. Use of the App</h2>
            ...
            {/* Section 4 */}
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">4. Privacy</h2>
              <p className="text-blue-100 text-sm md:text-base">Your use of the app is also governed by our <a href="/privacy" className="underline text-yellow-300">Privacy Policy</a>.</p>
            </div>
            {/* Section 5 */}
            <div className="mb-8">
            ...
            {/* Section 6 */}
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">6. Limitation of Liability</h2>
              <ul className="list-disc list-inside text-blue-100 space-y-2 text-xs md:text-sm">
            ...
            {/* Section 7 */}
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">7. Changes to Terms</h2>
              <p className="text-blue-100 text-sm md:text-base">We may update these Terms from time to time. Continued use of the app after changes means you accept the new Terms.</p>
            </div>
            {/* Section 8 */}
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">8. Termination</h2>
              <p className="text-blue-100 text-sm md:text-base">We may suspend or terminate your access to the app at any time for violation of these Terms or for any other reason.</p>
            </div>
            {/* Section 9 */}
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">9. Governing Law</h2>
              <p className="text-blue-100 text-sm md:text-base">These Terms are governed by the laws of India. Any disputes will be resolved in the courts of India.</p>
            </div>
            {/* Section 10 */}
